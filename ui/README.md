...
for javascript projects in DDF Registry. It was originally extracted from DDF. 
See [DDF UI README](https://github.com/codice/ddf/blob/master/ui/README.md) for more details.
